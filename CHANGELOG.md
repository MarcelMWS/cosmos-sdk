...
* [\#4255](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/4255) Add supply module that passively tracks the supplies of a chain
  ...
  [\#4472](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/4472) validation for crisis genesis
...
* [\#4588](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/4588) Context does not depend on x/auth anymore. client/context is stripped out of the following features:
  - GetAccountDecoder()
...
* [\#3825](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/3825) Validate genesis before running gentx
...
* SDK
  ...
  * [staking] [\#1268](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/1268) `LooseTokens` -> `NotBondedTokens`
...
* Gaia
    ...
    * [x/stake] [\#2221](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/2221) New
...
* SDK
    ...
    * [simulation] Rename TestAndRunTx to Operation [#2153](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/pull/2153)
    * [simulation] Remove log and testing.TB from Operation and Invariants, in favor of using errors [\#2282](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/2282)
    * [simulation] Remove usage of keys and addrs in the types, in favor of simulation.Account [\#2384](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/2384)
    * [tools] Removed gocyclo [#2211](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/2211)
    * [baseapp] Remove `SetTxDecoder` in favor of requiring the decoder be set in baseapp initialization. [#1441](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/1441)
    * [baseapp] [\#1921](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/1921) Add minimumFees field to BaseApp.
    * [store] Change storeInfo within the root multistore to use tmhash instead of ripemd160 [\#2308](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/2308)
    * [codec] [\#2324](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/2324) All referrences to wire have been renamed to codec. Additionally, wire.NewCodec is now codec.New().
    * [types] [\#2343](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/2343) Make sdk.Msg have a names field, to facilitate automatic tagging.
    * [baseapp] [\#2366](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/2366) Automatically add action tags to all messages
    * [x/auth] [\#2377](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/2377) auth.StdSignMsg -> txbuilder.StdSignMsg
    * [x/staking] [\#2244](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/2244) staking now holds a consensus-address-index instead of a consensus-pubkey-index
    * [x/staking] [\#2236](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/2236) more distribution hooks for distribution
    * [x/stake] [\#2394](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/2394) Split up UpdateValidator into distinct state transitions applied only in EndBlock
    * [x/slashing] [\#2480](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/2480) Fix signing info handling bugs & faulty slashing
    * [x/stake] [\#2412](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/2412) Added an unbonding validator queue to EndBlock to automatically update validator.Status when finished Unbonding
    * [x/stake] [\#2500](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/2500) Block conflicting redelegations until we add an index
    * [x/params] Global Paramstore refactored
    * [types] [\#2506](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/2506) sdk.Dec MarshalJSON now marshals as a normal Decimal, with 10 digits of decimal precision
    * [x/stake] [\#2508](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/2508) Utilize Tendermint power for validator power key
    * [x/stake] [\#2531](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/2531) Remove all inflation logic
    * [x/mint] [\#2531](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/2531) Add minting module and inflation logic
    * [x/auth] [\#2540](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/2540) Rename `AccountMapper` to `AccountKeeper`.
    * [types] [\#2456](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/2456) Renamed msg.Name() and msg.Type() to msg.Type() and msg.Route() respectively
...
* Gaia REST API (`gaiacli advanced rest-server`)
  ...
  * [gaia-lite] [\#2110](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/2110) Add support for `simulate=true` requests query argument to endpoints that send txs to run simulations of transactions
  * [gaia-lite] [\#966](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/966) Add support for `generate_only=true` query argument to generate offline unsigned transactions
  * [gaia-lite] [\#1953](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/1953) Add /sign endpoint to sign transactions generated with `generate_only=true`.
  * [gaia-lite] [\#1954](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/1954) Add /broadcast endpoint to broadcast transactions signed by the /sign endpoint.
  * [gaia-lite] [\#2113](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/2113) Rename `/accounts/{address}/send` to `/bank/accounts/{address}/transfers`, rename `/accounts/{address}` to `/auth/accounts/{address}`, replace `proposal-id` with `proposalId` in all gov endpoints
  * [gaia-lite] [\#2478](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/2478) Add query gov proposal's deposits endpoint
  * [gaia-lite] [\#2477](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/2477) Add query validator's outgoing redelegations and unbonding delegations endpoints

* Gaia CLI  (`gaiacli`)
  * [cli] Cmds to query staking pool and params
  * [gov][cli] [\#2062](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/2062) added `--proposal` flag to `submit-proposal` that allows a JSON file containing a proposal to be passed in
  * [\#2040](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/2040) Add `--bech` to `gaiacli keys show` and respective REST endpoint to
  provide desired Bech32 prefix encoding
  * [cli] [\#2047](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/2047) [\#2306](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/pull/2306) Passing --gas=simulate triggers a simulation of the tx before the actual execution.
  The gas estimate obtained via the simulation will be used as gas limit in the actual execution.
  * [cli] [\#2047](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/2047) The --gas-adjustment flag can be used to adjust the estimate obtained via the simulation triggered by --gas=simulate.
  * [cli] [\#2110](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/2110) Add --dry-run flag to perform a simulation of a transaction without broadcasting it. The --gas flag is ignored as gas would be automatically estimated.
  * [cli] [\#2204](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/2204) Support generating and broadcasting messages with multiple signatures via command line:
    * [\#966](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/966) Add --generate-only flag to build an unsigned transaction and write it to STDOUT.
    * [\#1953](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/1953) New `sign` command to sign transactions generated with the --generate-only flag.
    * [\#1954](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/1954) New `broadcast` command to broadcast transactions generated offline and signed with the `sign` command.
  * [cli] [\#2220](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/2220) Add `gaiacli config` feature to interactively create CLI config files to reduce the number of required flags
  * [stake][cli] [\#1672](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/1672) Introduced
  new commission flags for validator commands `create-validator` and `edit-validator`.
  * [stake][cli] [\#1890](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/1890) Add `--genesis-format` flag to `gaiacli tx create-validator` to produce transactions in genesis-friendly format.
  * [cli][\#2554](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/2554) Make `gaiacli keys show` multisig ready.

* Gaia
  * [cli] [\#2170](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/2170) added ability to show the node's address via `gaiad tendermint show-address`
  * [simulation] [\#2313](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/2313) Reworked `make test_sim_gaia_slow` to `make test_sim_gaia_full`, now simulates from multiple starting seeds in parallel
  * [cli] [\#1921] (https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/1921)
    * New configuration file `gaiad.toml` is now created to host Gaia-specific configuration.
    * New --minimum_fees/minimum_fees flag/config option to set a minimum fee.

* SDK
  * [querier] added custom querier functionality, so ABCI query requests can be handled by keepers
  * [simulation] [\#1924](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/1924) allow operations to specify future operations
  * [simulation] [\#1924](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/1924) Add benchmarking capabilities, with makefile commands "test_sim_gaia_benchmark, test_sim_gaia_profile"
  * [simulation] [\#2349](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/2349) Add time-based future scheduled operations to simulator
  * [x/auth] [\#2376](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/2376) Remove FeePayer() from StdTx
  * [x/stake] [\#1672](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/1672) Implement
...
* Gaia REST API (`gaiacli advanced rest-server`)
    * [x/stake] [\#2000](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/2000) Added tests for new staking endpoints
    * [gaia-lite] [\#2445](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/2445) Standarized REST error responses
    * [gaia-lite] Added example to Swagger specification for /keys/seed.
    * [x/stake] Refactor REST utils

* Gaia CLI  (`gaiacli`)
    * [cli] [\#2060](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/2060) removed `--select` from `block` command
    * [cli] [\#2128](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/2128) fixed segfault when exporting directly after `gaiad init`
    * [cli] [\#1255](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/1255) open KeyBase in read-only mode
     for query-purpose CLI commands
    * [docs] Added commands for querying governance deposits, votes and tally

* Gaia
    * [x/stake] [#2023](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/pull/2023) Terminate iteration loop in `UpdateBondedValidators` and `UpdateBondedValidatorsFull` when the first revoked validator is encountered and perform a sanity check.
    * [x/auth] Signature verification's gas cost now accounts for pubkey type. [#2046](https://github.com/tendermint/tendermint/pull/2046)
    * [x/stake] [x/slashing] Ensure delegation invariants to jailed validators [#1883](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/1883).
    * [x/stake] Improve speed of GetValidator, which was shown to be a performance bottleneck. [#2046](https://github.com/tendermint/tendermint/pull/2200)
    * [x/stake] [\#2435](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/2435) Improve memory efficiency of getting the various store keys
    * [genesis] [\#2229](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/2229) Ensure that there are no duplicate accounts or validators in the genesis state.
    * [genesis] [\#2450](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/2450) Validate staking genesis parameters.
    * Add SDK validation to `config.toml` (namely disabling `create_empty_blocks`) [\#1571](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/1571)
    * [\#1941](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/1941)(https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/1941) Version is now inferred via `git describe --tags`.
    * [x/distribution] [\#1671](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/1671) add distribution types and tests

* SDK
    * [tools] Make get_vendor_deps deletes `.vendor-new` directories, in case scratch files are present.
    * [spec] Added simple piggy bank distribution spec
    * [cli] [\#1632](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/1632) Add integration tests to ensure `basecoind init && basecoind` start sequences run successfully for both `democoin` and `basecoin` examples.
    * [store] Speedup IAVL iteration, and consequently everything that requires IAVL iteration. [#2143](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/2143)
    * [store] [\#1952](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/1952), [\#2281](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/2281) Update IAVL dependency to v0.11.0
    * [simulation] Make timestamps randomized [#2153](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/pull/2153)
    * [simulation] Make logs not just pure strings, speeding it up by a large factor at greater block heights [\#2282](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/2282)
    * [simulation] Add a concept of weighting the operations [\#2303](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/2303)
    * [simulation] Logs get written to file if large, and also get printed on panics [\#2285](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/2285)
    * [simulation] Bank simulations now makes testing auth configurable [\#2425](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/2425)
    * [gaiad] [\#1992](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/1992) Add optional flag to `gaiad testnet` to make config directory of daemon (default `gaiad`) and cli (default `gaiacli`) configurable
    * [x/stake] Add stake `Queriers` for Gaia-lite endpoints. This increases the staking endpoints performance by reusing the staking `keeper` logic for queries. [#2249](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/pull/2149)
    * [store] [\#2017](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/2017) Refactor
    gas iterator gas consumption to only consume gas for iterator creation and `Next`
    calls which includes dynamic consumption of value length.
    * [types/decimal] [\#2378](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/2378) - Added truncate functionality to decimal
    * [client] [\#1184](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/1184) Remove unused `client/tx/sign.go`.
    * [tools] [\#2464](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/2464) Lock binary dependencies to a specific version
    * #2573 [x/distribution] add accum invariance

BUG FIXES

* Gaia CLI  (`gaiacli`)
    * [cli] [\#1997](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/1997) Handle panics gracefully when `gaiacli stake {delegation,unbond}` fail to unmarshal delegation.
    * [cli] [\#2265](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/2265) Fix JSON formatting of the `gaiacli send` command.
    * [cli] [\#2547](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/2547) Mark --to and --amount as required flags for `gaiacli tx send`.

* Gaia
  * [x/stake] Return correct Tendermint validator update set on `EndBlocker` by not
  including non previously bonded validators that have zero power. [#2189](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/2189)
  * [docs] Fixed light client section links

* SDK
    * [\#1988](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/1988) Make us compile on OpenBSD (disable ledger) [#1988] (https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/1988)
    * [\#2105](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/2105) Fix DB Iterator leak, which may leak a go routine.
    * [ledger] [\#2064](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/2064) Fix inability to sign and send transactions via the LCD by
    loading a Ledger device at runtime.
    * [\#2158](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/2158) Fix non-deterministic ordering of validator iteration when slashing in `gov EndBlocker`
    * [simulation] [\#1924](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/1924) Make simulation stop on SIGTERM
    * [\#2388](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/2388) Remove dependency on deprecated tendermint/tmlibs repository.
    * [\#2416](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/2416) Refactored `InitializeTestLCD` to properly include proposing validator in genesis state.
...
* Gaia REST API (`gaiacli advanced rest-server`)
  - [x/stake] [\#1880](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/1880) More REST-ful endpoints (large refactor)
  - [x/slashing] [\#1866](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/1866) `/slashing/signing_info` takes cosmosvalpub instead of cosmosvaladdr
...
* Gaia CLI  (`gaiacli`)
  ...
  -  [x/stake] [\#1828](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/1828) Force user to specify amount on create-validator command by removing default
  -  [x/gov] Change `--proposalID` to `--proposal-id`
  -  [x/stake, x/gov] [\#1606](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/1606) Use `--from` instead of adhoc flags like `--address-validator`
        and `--proposer` to indicate the sender address.
  -  [\#1551](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/1551) Remove `--name` completely
...
* Gaia
  ...
  - [x/gov] [\#1781](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/1781) Added tags sub-package, changed tags to use dash-case
  - [x/gov] [\#1688](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/1688) Governance parameters are now stored in globalparams store
  - [x/gov] [\#1859](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/1859) Slash validators who do not vote on a proposal
  - [x/gov] [\#1914](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/1914) added TallyResult type that gets stored in Proposal after tallying is finished
...
* SDK
  ...
  - [client] [\#1551](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/1551): Refactored `CoreContext` to `TxContext` and `QueryContext`
...
* Tendermint
    ...
    - v0.23.0 -> See
      ...
      and [SDK PR](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/pull/1927)
...
* Gaia CLI  (`gaiacli`)
    ...
    - [x/stake] [\#2043](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/2043) Added staking query cli cmds for unbonding-delegations and redelegations
...
* SDK
  ...
  - [store] [\#1481](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/1481) Add transient store
...
* Gaia
  - [spec] [\#967](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/967) Inflation and distribution specs drastically improved
  - [x/gov] [\#1773](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/1773) Votes on a proposal can now be queried
  - [x/gov] Initial governance parameters can now be set in the genesis file
  - [x/stake] [\#1815](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/1815) Sped up the processing of `EditValidator` txs.
  - [config] [\#1930](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/1930) Transactions indexer indexes all tags by default.
  - [ci] [#2057](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/pull/2057) Run `make localnet-start` on every commit and ensure network reaches at least 10 blocks

* SDK
  - [baseapp] [\#1587](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/1587) Allow any alphanumeric character in route
  - [baseapp] Allow any alphanumeric character in route
  - [tools] Remove `rm -rf vendor/` from `make get_vendor_deps`
  - [x/auth] Recover ErrorOutOfGas panic in order to set sdk.Result attributes correctly
  - [x/auth] [\#2376](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/2376) No longer runs any signature in a multi-msg, if any account/sequence number is wrong.
  - [x/auth] [\#2376](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/2376) No longer charge gas for subtracting fees
  - [x/bank] Unit tests are now table-driven
  - [tests] Add tests to example apps in docs
  - [tests] Fixes ansible scripts to work with AWS too
  - [tests] [\#1806](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/1806) CLI tests are now behind the build flag 'cli_test', so go test works on a new repo

BUG FIXES

* Gaia CLI  (`gaiacli`)
  -  [\#1766](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/1766) Fixes bad example for keybase identity
  -  [x/stake] [\#2021](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/2021) Fixed repeated CLI commands in staking

* Gaia
  - [x/stake] [#2077](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/pull/2077) Fixed invalid cliff power comparison
  - [\#1804](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/1804) Fixes gen-tx genesis generation logic temporarily until upstream updates
  - [\#1799](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/1799) Fix `gaiad export`
  - [\#1839](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/1839) Fixed bug where intra-tx counter wasn't set correctly for genesis validators
  - [x/stake] [\#1858](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/1858) Fixed bug where the cliff validator was not updated correctly
  - [tests] [\#1675](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/1675) Fix non-deterministic `test_cover`
  - [tests] [\#1551](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/1551) Fixed invalid LCD test JSON payload in `doIBCTransfer`
  - [basecoin] Fixes coin transaction failure and account query [discussion](https://forum.cosmos.network/t/unmarshalbinarybare-expected-to-read-prefix-bytes-75fbfab8-since-it-is-registered-concrete-but-got-0a141dfa/664/6)
  - [x/gov] [\#1757](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/1757) Fix VoteOption conversion to String
...
*  [\#1797](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/1797) Fix off-by-one error in slashing for downtime
*  [\#1787](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/1787) Fixed bug where Tally fails due to revoked/unbonding validator
*  [\#1666](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/1666) Add intra-tx counter to the genesis validators
...
BUG FIXES
* [\#1630](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/1630) - redelegation nolonger removes tokens from the delegator liquid account
* [keys] [\#1629](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/1629) - updating password no longer asks for a new password when the first entered password was incorrect
...
BUG FIXES
* [x/slashing] [\#1510](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/1510) Unrevoked validators cannot un-revoke themselves
* [x/stake] [\#1513](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/1513) Validators slashed to zero power are unbonded and removed from the store
* [x/stake] [\#1567](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/1567) Validators decreased in power but not unbonded are now updated in Tendermint
...
* [\#872](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/872)  - recovery phrases no longer all end in `abandon`
* [\#887](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/887)  - limit the size of rationals that can be passed in from user input
* [\#1052](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/1052) - Make all now works
* [\#1258](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/1258) - printing big.rat's can no longer overflow int64
* [\#1259](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/1259) - fix bug where certain tests that could have a nil pointer in defer
* [\#1343](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/1343) - fixed unnecessary parallelism in CI
* [\#1353](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/1353) - CLI: Show pool shares fractions in human-readable format
* [\#1367](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/1367) - set ChainID in InitChain
* [\#1461](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/1461) - CLI tests now no longer reset your local environment data
* [\#1505](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/1505) - `gaiacli stake validator` no longer panics if validator doesn't exist
* [\#1565](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/1565) - fix cliff validator persisting when validator set shrinks from max
* [\#1287](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/1287) - prevent zero power validators at genesis
* [x/stake] fix bug when unbonding/redelegating using `--shares-percent`
* [\#1010](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/1010) - two validators can't bond with the same pubkey anymore
...
FIXES
* Fixes consensus fault on testnet - see postmortem [here](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/1197#issuecomment-396823021)
...
[Unreleased]: https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/compare/v0.37.0...HEAD
[v0.37.0]: https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/releases/tag/v0.37.0
[v0.36.0]: https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/releases/tag/v0.36.0
