...
```bash
go test -v --bench repo.mwaysolutions.com/blockscape/gaia-yubihsm/crypto/keys/mintkey
```
...
goos: linux
goarch: amd64
pkg: repo.mwaysolutions.com/blockscape/gaia-yubihsm/crypto/keys/mintkey
...
PASS
ok  	repo.mwaysolutions.com/blockscape/gaia-yubihsm/crypto/keys/mintkey	12.093s
```
