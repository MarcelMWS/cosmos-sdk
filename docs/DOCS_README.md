...
If you want to open a PR on the Cosmos SDK to update the documentation, please follow the guidelines in the [`CONTRIBUTING.md`](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/tree/master/CONTRIBUTING.md)
...
[master](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/tree/master/docs).
...
Then, edit the `swagger.yaml` manually; it is found [here](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/blob/master/client/lcd/swagger-ui/swagger.yaml)
