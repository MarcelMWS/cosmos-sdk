...
다음 항목은 [Light-Client](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/tree/master/docs/interfaces/lite) 기능을 제공하려는 월렛 개발자들에게 해당하지 않습니다. 서비스 제공자는 엔드 유저와 블록체인을 이어주는 신뢰할 수 있는 기관/개인입니다.
