...
# " [\#number](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/<number>)
...
for line in fileinput.input(inplace=1):
    line = re.sub(r"\s\\#([0-9]+)", r" [\\#\1](https://repo.mwaysolutions.com/blockscape/gaia-yubihsm/issues/\1)", line.rstrip())
    print(line)